...
SELECT Full_Name=Fname+Lname, [ANNUAL COMM]=12*0.1*Salary FROM Employee;

-- 5.	Display the employees Id, name who earns more than 1000 LE monthly.
SELECT SSN FROM Employee WHERE Salary > 1000;

-- 6.	Display the employees Id, name who earns more than 10000 LE annually.
SELECT SSN FROM Employee WHERE Salary*12 > 10000;

-- 7.	Display the names and salaries of the female employees
SELECT Full_Name=Fname+Lname, Salary FROM Employee WHERE Sex = 'F';
